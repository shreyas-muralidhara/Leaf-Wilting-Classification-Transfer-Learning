...
A ResNet50 based model to tackle the multi-class classification problem of detecting leaf wilting levels from images. This was my project in "ECE 542: Neural Networks and Deep Learning" course at NC State University.
